...
import org.kbeng.games.rpg.item.Armor;
import org.kbeng.games.rpg.item.Axe;
import org.kbeng.games.rpg.item.Backpack;
import org.kbeng.games.rpg.item.Boots;
import org.kbeng.games.rpg.item.Chestplate;
import org.kbeng.games.rpg.item.Helmet;
import org.kbeng.games.rpg.item.Hoe;
import org.kbeng.games.rpg.item.Material;
import org.kbeng.games.rpg.item.MiningComponent;
import org.kbeng.games.rpg.item.Pickaxe;
import org.kbeng.games.rpg.item.Shield;
import org.kbeng.games.rpg.item.Shovel;
...
import org.kbeng.games.rpg.utils.Naming;
