package org.kbeng.games.rpg.ui;

import org.kbeng.engine.ui.Frontend;
import org.kbeng.engine.ui.UIElement;
import org.kbeng.engine.ui.UIWidget;
import org.kbeng.games.rpg.data.BlockData;
import org.kbeng.games.rpg.data.InventorySlot;
import org.kbeng.games.rpg.data.SlotType;
...
import org.kbeng.games.rpg.item.Bucket;
...
import org.kbeng.games.rpg.utils.ItemIds;
import org.joml.Vector4f;

import java.lang.Character;

/**
 * InventorySlotUI provides inventory slot ui capabilities within the ui subsystem.
...
public class InventorySlotUI extends UIElement implements UIWidget {
    ...
    @Override
    public String formatTooltip(String tooltipText) {
        return ItemIds.appendToTooltip(tooltipText, getItem());
    }
    ...
    private void renderItem() {
        ...
        Frontend.drawSprite(spriteSheet, spriteFrame, x, y, renderWidth, renderHeight,
                new Vector4f(K.UI.UI_ITEM_TINT.x, K.UI.UI_ITEM_TINT.y, K.UI.UI_ITEM_TINT.z,
                        K.UI.UI_ITEM_TINT.w * getWorldOpacity()), getItem() instanceof Tool);
