...
public enum SoundGroup {
    SOIL(new String[]{"fx/steps/steps_grass_01.ogg", "fx/steps/steps_grass_02.ogg", "fx/steps/steps_grass_03.ogg", "fx/steps/steps_grass_04.ogg"}, new String[]{"fx/blocks/dig.ogg", "fx/blocks/dirt.ogg"}, new String[]{"fx/blocks/soil_tumbling.ogg"}, new String[]{"fx/blocks/dirt.ogg"}, new String[]{}, new String[]{}, new String[]{"fx/blocks/dirt.ogg"}, new String[]{}, new String[]{}),
    ...
    STONE(new String[]{}, new String[]{"fx/blocks/mining.ogg"}, new String[]{"fx/blocks/stone_tumbling.ogg"},new String[]{}, new String[]{}, new String[]{}, new String[]{"fx/blocks/mining.ogg", "fx/blocks/chop.ogg"}, new String[]{}, new String[]{}),
    WOOD(new String[]{"fx/blocks/wood.ogg"}, new String[]{"fx/blocks/wood.ogg"}, new String[]{"fx/blocks/wood_tumbling.ogg"}, new String[]{"fx/blocks/wood.ogg"}, new String[]{},new String[]{}, new String[]{}, new String[]{}, new String[]{}),
    ...
    ENTITY(new String[]{}, new String[]{"fx/entity/fall.ogg"}, new String[]{}, new String[]{}, new String[]{"fx/entity/hurt.ogg"}, new String[]{}, new String[]{}, new String[]{}, new String[]{}),
    NPC(new String[]{}, new String[]{}, new String[]{}, new String[]{}, new String[]{}, new String[]{}, new String[]{}, new String[]{}, new String[]{"fx/entity/hmm_female.ogg", "fx/entity/hmm_female_disapproving.ogg", "fx/entity/hurt_female.ogg", "fx/entity/hmm_male.ogg", "fx/entity/hmm_male_disapproving.ogg"}),
